    ...
    mainPanel(
	  h4('Documentation'),
        p("Monitoring  Body Mass Index (BMI) and percent fat content is important to monitor health status.  
           ...
           fat content based on BMI, age and gender. The Instruction on how to uss the App. is given below"),
        h4('Instructions'),
	  ...
	  h6(em('Note: The equations to calculate percent fat content is taken from: http://www.halls.md/bmi/fat.htm')),
        h6('The image below shows the BMI ranges for males: '),
	  img(src="bmi-male.jpg", height = 920, width = 467),
        h6('The image below shows the BMI ranges for females: '),
